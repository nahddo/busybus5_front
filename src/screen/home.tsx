      ...
      <View style={styles.container}>
        ...
        <View style={styles.statusBar}>
          ...
          <View style={styles.statusIcons}>
            <Image
              source={require("../../assets/images/home/Cellular Connection.png")}
              style={styles.statusIcon}
              resizeMode="contain"
            />
            <Image
              source={require("../../assets/images/home/Wifi.png")}
              style={styles.statusIcon}
              resizeMode="contain"
            />
            <Image
              source={require("../../assets/images/home/Battery.png")}
        ...
        <View style={styles.routeCardWrapper}>
          <View style={styles.routeCardHeader}>
            <Text style={styles.routeCardTitle}>오늘의 경로</Text>
